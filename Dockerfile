...
RUN wget --no-check-certificate https://github.com/harmony-one/harmony/releases/download/v2023.2.7/harmony && chmod +x harmony && mv harmony /usr/local/bin/harmony
