...
RUN wget --no-check-certificate https://github.com/harmony-one/harmony/releases/download/v4.3.14.rc3/harmony && chmod +x harmony && mv harmony /usr/local/bin/harmony
