...
RUN wget --no-check-certificate https://github.com/harmony-one/harmony/releases/download/v2024.3.1/harmony && chmod +x harmony && mv harmony /usr/local/bin/harmony
