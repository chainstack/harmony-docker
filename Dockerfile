...
RUN wget --no-check-certificate https://github.com/harmony-one/harmony/releases/download/v2026.0.0/harmony && chmod +x harmony && mv harmony /usr/local/bin/harmony
